layui.use(['form', 'layedit', 'layer'], function () {
    ...
    form.render('select', 'receivablesCreateForm');
    ...
    if (editId) {
        ...
        $.ajax({
            url: COMMON.filterURL('/v2/receivables/detail'),
            type: 'get',
            data: { id: editId },
            success: function (res) {
                if (res.code === 200 && res.data) {
                    ...
                    $('#receiv_year').val((res.data.receiv_year || ''));
                    $('#receiv_month').val((res.data.receiv_month || ''));
                    $('#receiv_day').val((res.data.receiv_day || ''));
                    ...
                    $('#receiv_amount').val((res.data.receiv_amount || ''));
    ...
    form.on('submit(createReceivables)', function (data) {
